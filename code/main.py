...
class Game:
    def __init__(self):
        ...
        #--SPRITES--
        for i in range(20):
            self.collision = Collision_sprite((self.all_sprites, self.collision_sprite), (randint(0,window_width),randint(0, window_height)), (400,400))
        self.player = Player(self.all_sprites, (400, 200))
